function sendDataToBackend(event) {
    ...
    var settings = {
        "url": "https://strength-visualiser.herokuapp.com/login",//when update button is pressed, it calls this API in app.js which then process it just like postman. only difference is that browser is calling api instead of postman
        "method": "POST",
        "timeout": 0,
        "headers": {
